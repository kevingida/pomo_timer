...
import useTaskState from "@/features/task/hooks/useTasksState";
import { Task } from "@/features/task/type";

const getItemMock = localStorage.getItem as jest.MockedFunction<
  Storage["getItem"]
>;
...
describe("useTasksState", () => {
  ...
  describe("initialization", () => {
    ...
    it("should load tasks from localStorage on mount", () => {
      ...
      getItemMock.mockReturnValue(JSON.stringify(mockTasks));
  ...
  describe("localStorage persistence", () => {
    ...
    it("should not save to localStorage until loaded", () => {
      ...
      const setItemCallsBefore = (localStorage.setItem as jest.Mock).mock.calls
        .length;
      ...
      const setItemCallsAfter = (localStorage.setItem as jest.Mock).mock.calls
        .length;
